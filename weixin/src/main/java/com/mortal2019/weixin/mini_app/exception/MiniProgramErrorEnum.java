 ...
 * @author wuyiyuan
 * @version v1.0.0.0
 * Created DateTime 2023/4/26 11:46
 */
public enum MiniProgramErrorEnum {
    /**
     * <pre>
     ...
     * 对应地址：
     * POST <a href="https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN">POST</a>
     * https://developers.weixin.qq.com/miniprogram/dev/api/open-api/customer-message/sendCustomerMessage.html
     * </pre>
     */
     ...
     * 对应操作：<code>sendCustomerMessage</code>
     * 对应地址：
     * <a href="https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN">POST</a>
     * <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/customer-message/sendCustomerMessage.html">参考文档地址</a>
     * </pre>
     */
     ...
     * 对应地址：
     * <a href="https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN">POST</a>
     * <a href="https://api.weixin.qq.com/cgi-bin/message/wxopen/template/uniform_send?access_token=ACCESS_TOKEN">POST</a>
     * <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/customer-message/sendCustomerMessage.html">参考文档地址1</a>
     * <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/uniform-message/sendUniformMessage.html">参考文档地址2</a>
     * </pre>
     */
     ...
     * 对应地址：
     * GET <a href="https://api.weixin.qq.com/cgi-bin/media/get?access_token=ACCESS_TOKEN&media_id=MEDIA_ID">...</a>
     * 参考文档地址： <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/customer-message/getTempMedia.html">...</a>
     * </pre>
     */
     ...
     * 对应地址：
     * POST <a href="https://api.weixin.qq.com/cgi-bin/message/wxopen/template/uniform_send?access_token=ACCESS_TOKEN">...</a>
     * 参考文档地址： <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/uniform-message/sendUniformMessage.html">...</a>
     * </pre>
     */
    CODE_40013(40013, "appid不正确，或者不符合绑定关系要求"),
    /**
     * <pre>
     * appSecret不正确，或者不符合绑定关系要求.
     * 对应操作：<code>sendUniformMessage</code>
     * 对应地址：
     * POST <a href="https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential">...</a>
     * 参考文档地址： <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/uniform-message/sendUniformMessage.html">...</a>
     * </pre>
     */
    CODE_40125(40125, "appSecret不正确，或者不符合绑定关系要求"),
    /**
     * <pre>
     * template_id 不正确.
     ...
     * 对应地址：
     * POST <a href="https://api.weixin.qq.com/wxa/img_sec_check?access_token=ACCESS_TOKEN">...</a>
     * POST <a href="https://api.weixin.qq.com/wxa/msg_sec_check?access_token=ACCESS_TOKEN">...</a>
     * 参考文档地址： <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/sec-check/imgSecCheck.html">...</a>
     * <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/sec-check/msgSecCheck.html">...</a>
     * </pre>
     */
    ...
    /**
     * <a href="https://developers.weixin.qq.com/doc/oplatform/Third-party_Platforms/Mini_Programs/Intro.html">代小程序实现业务的错误码，部分和小程序业务一致</a>
     */
    ...
    /**
     * <a href="https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/subscribe-message/subscribeMessage.send.html">小程序订阅消息错误码</a>
     */
...
//  CODE_504002(-504002, "云函数未找到 Function not found"),
    ...
    MiniProgramErrorEnum(int code, String msg) {
        this.code = code;
        this.msg = msg;
    }

    static final Map<Integer, String> VALUE_MAP = new HashMap<>(16);

    static {
        for (MiniProgramErrorEnum value : MiniProgramErrorEnum.values()) {
            VALUE_MAP.put(value.code, value.msg);
        }
    }
    ...
    public static String findMsgByCode(int code) {
        return VALUE_MAP.getOrDefault(code, null);
    }
}
